...
public class RegistrationAccountMenu {

    private Stage stage=new Stage();

    public  void Show(){
        FXMLLoader loader=new FXMLLoader();
        loader.setLocation(getClass().getResource("/templates/registration_account_menu.fxml"));
        try {
            loader.load();
        } catch (IOException e) {
            e.printStackTrace();
        ...
        login.textProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observableValue, String s, String t1) {
                ...
                if(t1.equals("")){
                    ...
                    login_icon.getTooltip().setText("Придумайте логин");
                }
                else {
                    icon.setIcon(FontAwesomeIcon.CHECK);
                    login_icon.getStyleClass().remove("label_sec");
                    login_icon.getStyleClass().add("label_sec");
                    login_icon.getTooltip().setText("Успешно");
                }
            }
        });
        password.textProperty().addListener(new ChangeListener<String>() {
            ...
            public void changed(ObservableValue<? extends String> observableValue, String s, String t1) {
                ...
                if(t1.equals("")){
                    ...
                    password_icon.getTooltip().setText("Придумайте логин");
                }
                else {
                    icon.setIcon(FontAwesomeIcon.CHECK);
                    password_icon.getStyleClass().remove("label_sec");
                    password_icon.getStyleClass().add("label_sec");
                    password_icon.getTooltip().setText("Успешно");
                }
            }
        });
            ...
            if(block_reg.getChildren()
                ...
                try {
                    ...
                    if(headerMessage==HeaderMessage.ACCOUNT_IS_EXISTS){
                        ...
                        alert.setContentText("Регистрация прошла успешно ваш аккаунт активен и вы можете использовать его ");
                        alert.show();
                    }
